...
⚠️ Villain was explicitly developed and tested on **kali linux**.\
⚠️ This guide is a work in progress currently describing key features. Check out Villain's introduction on youtube for more info.
...
1. [News](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#News)
2. [Generate Reverse Shell Commands](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#Generate-Reverse-Shell-Commands)
3. [Connect With Sibling Server](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#Connect-With-Sibling-Server)
4. [Shell](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#shell)
5. [Upload Command](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#upload)
6. [Conptyshell](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#Conptyshell)
7. [Exec](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#Exec)
8. [Flee](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#Flee)
9. [Purge](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#Purge)
10. [Chat with Sibling Servers](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#Chat-with-Sibling-Servers)
11. [Session Defender](https://github.com/t3l3machus/Villain/blob/main/Usage_Guide.md#Session-Defender)
...
⚡Reverse TCP based shells are more stable and reliable than HoaxShell. ⚠️HoaxShell payloads are not reusable (will work only once). I will probably change that in the future.
